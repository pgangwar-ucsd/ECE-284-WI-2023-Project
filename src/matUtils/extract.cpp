...
//    //////////////////////////////////////////////////////// HERE
//    
//    std::vector<std::string> in_lineage = {"B.1", "B.57"};
//    std::vector<float> in_distribution = {0.8, 0.2};
//    
//    std::vector<MAT::Node*> traversal, lineage_list, lineage_selected;
//    std::vector<float>::iterator distribution = in_distribution.begin();
//    
...
//                if (str == lineage) {
//                    lineage_list.emplace_back(n);
//                    list_start = true;
//                }
//                else {
//                    if ((str == "") && (list_start)) {
//                        auto it = std::find (lineage_list.begin(), lineage_list.end(), n);
//                        if (it == lineage_list.end()) {
//                            lineage_list.emplace_back(n);
//                            //fprintf(stderr, "Node: %s, Clade: %s\n\n", n->identifier.c_str(), str.c_str());
//                        }
//                        //std::cout << "BEFORE: ITER = " << (it - lineage_list.begin()) << ", END = " << (lineage_list.end() - lineage_list.begin())
//                        //    << " Node: " << n->identifier.c_str() << std::endl;
//                    }
//                    else {
//                        list_start = false;
//                    }
...
//        }
//
//        std::vector<int> random_vec;                                                        /// Randomly Selecting Lineages
//        fprintf(stderr, "\nLineage_list = %ld\n", lineage_list.size());
//        for (int i = 0; i < ceil((*distribution) * lineage_list.size()); i++) {
//            clock_t time = clock();
//            srand(int(time));
//            int rand_val = int(rand() % lineage_list.size());
//            auto it = std::find(random_vec.begin(), random_vec.end(), rand_val);
//            while (it != random_vec.end()) {
//                rand_val = int(rand() % lineage_list.size());
//                it = std::find(random_vec.begin(), random_vec.end(), rand_val);
//            }
//            random_vec.emplace_back(rand_val);
//        }
//        
//        for (auto itr: random_vec) {
//            fprintf(stderr, "%s\n", lineage_list[itr]->identifier.c_str());
//            lineage_selected.emplace_back(lineage_list[itr]);
//        }
//
//        lineage_list.clear();
//        random_vec.clear();
//        lineage_selected.clear();
//        traversal.clear();
...
////    void write_to_vcf(std::ostream& vcf_filename, std::vector<MAT::Node*> lineage_selected, 
...
////        try {
////            std::ofstream outfile(vcf_filename, std::ios::out | std::ios::binary);
